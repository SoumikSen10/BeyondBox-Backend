...
for (const {key,name} of filterVideos(videos)){
  ...
  videoCard.innerHTML=`
  <iframe width="500" height="294" src="https://www.youtube.com/embed/${key}?&theme=dark&color=white&rel=0" frameborder="0" allowfullscreen="1" title="${name}" nameclass="img-cover" loading="lazy"</iframe>
  `;
